Feature: Create a new master collection
  ...
  Scenario:
    Given I am logged in as "admin" with uid "admin@admin.me" and password "admin"
    ...
    And I create a role and a user from the table :
      ...
      |  Bob |  bob123   | HR_Manager | bob@admin.me |
    And I give the "HR_Manager" "index" authority over the "jobs" collection
    Then logged in as "Bob" with uid "bob@admin.me" and password "bob123" I can open the "jobs" management page
